...
df_dep   = pd.read_csv(os.path.join(BASE_DIR, 'data/deposits.csv'))
df_rb    = pd.read_csv(os.path.join(BASE_DIR, 'data/risk_behavior.csv'))
df_panic = pd.read_csv(os.path.join(BASE_DIR, 'data/panic_sell.csv'))
